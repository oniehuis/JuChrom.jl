...
For many downstream analyses — such as precise peak shape reconstruction and deconvolution — 
...
are non-negligible relative to chromatographic peak widths or when dwell distributions are 
heterogeneous.
...
- the dwell allocation across ions, the acquisition order of ions within the scan, and 
